...
Tableau tab  = { 7, 4, {                     // Size of tableau [4 rows x 5 columns ]
    { 0.0 , -5.0 , -5.0 , -5.0 },  // Max: z = 0.5*x + 3*y + z + 4*w,
    { 1.0 , 3.0 , 0.0 , 3.0 },  //    x + y + z + w <= 40 .. b1
    { 1.0 , 2.0 , 0.0 , 3.0 },  //  -2x - y + z + w <= 10 .. b2
    { 1.0 , 3.0 , 1.0 , 2.0 },  //        y     - w <= 10 .. b3
    { 1.0 , 1.0 , 3.0 , 1.0 },
    { 1.0 , 2.0 , 4.0 , 1.0 },
    { 1.0 , 0.0 , 5.0 , 0.0 }
  }
